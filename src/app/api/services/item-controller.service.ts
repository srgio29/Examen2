...
import { ItemPartial } from '../models/item-partial';
...
export class ItemControllerService extends BaseService {
  ...
  count$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ItemControllerService.ItemControllerCountPath, 'get');
    if (params) {
  ...
  replaceById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ItemControllerService.ItemControllerReplaceByIdPath, 'put');
    if (params) {
      rb.path('id', params.id, {});
  ...
  deleteById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ItemControllerService.ItemControllerDeleteByIdPath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
    }
  ...
  updateById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ItemControllerService.ItemControllerUpdateByIdPath, 'patch');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  find$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ItemControllerService.ItemControllerFindPath, 'get');
    if (params) {
      rb.query('filter', params.filter, {});
    }
  ...
  create$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ItemControllerService.ItemControllerCreatePath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  updateAll$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ItemControllerService.ItemControllerUpdateAllPath, 'patch');
    if (params) {
      rb.query('where', params.where, {});
      rb.body(params.body, 'application/json');
    }
